                    ...
                    <div id="editApp" class="w-full flex flex-col sm:flex-row items-start gap-6">
                        ...
                        <div id="previewColumn" class="flex-1 flex flex-col items-center">
                            ...
                            <div id="captionArea" class="mt-3 text-center">
                                <div id="captionText" class="text-sm text-[#2b0505] font-medium"></div>
                            </div>
                        </div>
                        ...
                        <div id="controls" class="w-full sm:w-80 flex-shrink-0 bg-transparent">
                            <div class="space-y-4">
                                <div class="card p-4 rounded-2xl bg-[#fff5f7] shadow-md shadow-pink-50 transition-all duration-200 hover:shadow-lg hover:ring-1 hover:ring-red-100">
                                    <div class="text-sm font-semibold text-red-600 mb-3">Background</div>
                                    <input id="bgColor" type="color" class="w-full h-10 p-0 rounded-lg border border-white/20 cursor-pointer" value="#fff5f7">
                                    <div class="mt-3 flex gap-2">
                                        <button data-color="#fff5f7" class="preset w-8 h-8 rounded-lg bg-[#fff5f7] border border-white/20 cursor-pointer" aria-label="preset 1"></button>
                                        <button data-color="#fde2e2" class="preset w-8 h-8 rounded-lg bg-[#fde2e2] border border-white/20 cursor-pointer" aria-label="preset 2"></button>
                                        <button data-color="#ffeedd" class="preset w-8 h-8 rounded-lg bg-[#ffeedd] border border-white/20 cursor-pointer" aria-label="preset 3"></button>
                                        <button data-color="#ffd6d6" class="preset w-8 h-8 rounded-lg bg-[#ffd6d6] border border-white/20 cursor-pointer" aria-label="preset 4"></button>
                                    </div>
                                </div>

                                <div class="card p-4 rounded-2xl bg-[#fff5f7] shadow-md transition-all duration-200 hover:shadow-lg hover:ring-1 hover:ring-red-100">
                                ...
                                <div class="card p-4 rounded-2xl bg-[#fff5f7] shadow-md transition-all duration-200 hover:shadow-lg hover:ring-1 hover:ring-red-100">
                                    ...
                                    <input id="captionInput" maxlength="10" type="text" placeholder="10 chars max" class="w-full p-3 rounded-lg border border-white/20 text-sm text-[#2b0505]" />
                                ...
                                <div class="pt-2">
                                    ...
                                    <div class="mt-3 flex items-center gap-3">
                                        ...
                                        <button id="btnAgain" class="flex-1 px-4 py-2 rounded-full bg-white/20 text-[#2b0505] cursor-pointer">Again</button>
                                    </div>
                                </div>
                            </div>
                        </div>
